  ...
  return <div className="internal-interview-setup">
    ...
    {!bankOnly && <Card title="Configure internal interview">
      ...
      <Form layout="vertical" className="internal-interview-form">
        ...
        <Form.Item className="interview-wide"><Space wrap><Checkbox checked={config.recordingEnabled} onChange={e => setConfig({ ...config, recordingEnabled: e.target.checked })}>Request recording consent</Checkbox><Checkbox checked={config.transcriptionEnabled} onChange={e => setConfig({ ...config, transcriptionEnabled: e.target.checked })}>Save written answers / AI review (with consent)</Checkbox></Space></Form.Item>
      </Form>
