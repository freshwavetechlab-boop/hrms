...
export const createPayRun = (body: { clientId: number; payPeriod: string; payDate: string; totalWorkingDays: number; runType?: string; runName?: string; reason?: string; excludedEmployeeIds?: number[]; includedEmployeeIds?: number[]; adjustmentIds?: number[] }) => postJson<typeof body, PayRun | null>('/api/pay-runs', body, null, { timeoutMs: 180000 })
