import type { Client, Component, Drop, Employee, Org, PayslipTemplate, Setup, Structure, WorkLocation } from '../types/payroll'
...
export const settingsMenus = ['Organization', 'Clients', 'Work Locations', 'Dropdown Masters', 'Pay Schedule', 'Salary Components', 'Salary Templates', 'Payslip Templates'] as const
