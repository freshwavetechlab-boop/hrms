...
('FIRST_NAME','Candidate first name','TEXT',TRUE),('LAST_NAME','Candidate last name','TEXT',TRUE),('EMAIL','Candidate email','EMAIL',TRUE),('PHONE','Candidate phone','PHONE',TRUE),('RESUME','Primary resume','UPLOAD',TRUE),('CONSENT','Candidate consent','CHECKBOX',TRUE),('CURRENT_LOCATION','Current location','TEXT',TRUE),('EXPECTED_CTC','Expected CTC','NUMBER',TRUE)
