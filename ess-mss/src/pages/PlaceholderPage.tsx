...
export function PlaceholderPage({ view, manager }: { view: View; manager: boolean }) {
  ...
  return <section className="feature-page"><div className="empty-work"><b>This feature is ready for activation.</b><span>{copy[view as Exclude<View, 'Dashboard'>] || 'The navigation, access boundary, user guidance, and workspace layout are in place.'}</span></div></section>
}
